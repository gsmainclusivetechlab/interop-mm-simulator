...
class RuleSets
{
	 ...
	 * @return string
	 */
	public static function requiredStandardString(): string
	{
    ...
    {
        return [
            $field . '.*.feeType' => self::requiredStandardString(),
    ...
    {
        return [
            $field . '.*.key' => self::requiredStandardString(),
            $field . '.*.value' => self::requiredStandardString(),
        ];
    }
